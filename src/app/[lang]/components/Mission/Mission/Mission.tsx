...
const Mission: React.FC<CommonProps> = async(locale) => {
  ...
  return (
    <div className='w-full bg-white lg:h-[694px] flex flex-col justify-center items-center sm:py-20'>
      <div className='w-full max-w-[1120px] sm:px-4'>
        <div className='w-full flex justify-between items-center sm:flex-col'>
          ...
          <p className='lg:w-[520px] font-bd-en text-navy07 text-body sm:py-6'>{data.headerIntro}</p>
        </div>
        <div className='w-full flex justify-between mt-16 sm:flex-col sm:justify-center sm:items-center'>
