    ...
    <div className='w-full lg:bg-service-svg sm:bg-navy bg-cover bg-no-repeat lg:h-[1578px] flex justify-center items-center sm:bg-center sm:py-20'>
        <div className='w-full max-w-[1180px] h-full flex overflow-hidden'>
            <div className='h-full flex flex-col gap-8 flex-wrap sm:items-center justify-center sm:px-4'>
                <p className='text-white w-[256px] text-header2-desktop font-hd-en mt-11 mb-5 sm:text-header2-mobile sm:text-center'>{data.header}</p>
                <Image className='sm:hidden' alt='service-image' src='./svg/service-intro.svg' width={363} height={596} />
                <div className='lg:w-[363px] lg:h-[388px] flex flex-col bg-white rounded-2xl p-8 lg:py-12 sm:w-full sm:h-auto'>
                    <Image alt={'ui'} src='./svg/ui.svg' className='bg-brand p-3 rounded-md' width={56} height={56} />
                    <p className=' text-navy text-subheader-bold my-4 font-bd-en'>{data.UI}</p>
                ...
                <div className='lg:w-[363px] lg:h-[388px] flex flex-col bg-white rounded-2xl p-8 lg:py-12 sm:w-full sm:h-auto'>
                    ...
                    <p className='text-navy text-subheader-bold my-4 font-bd-en'>{data.Ecosystem}</p>
                ...
                <div className='lg:w-[363px] lg:h-[388px] flex flex-col bg-white rounded-2xl p-8 lg:py-12 sm:w-full sm:h-auto'>
                    ...
                    <p className='text-navy text-subheader-bold my-4 font-bd-en'>{data.Development}</p>
                ...
                <div className='lg:w-[363px] lg:h-[388px] flex flex-col bg-white rounded-2xl p-8 lg:py-12 sm:w-full sm:h-auto'>
                    ...
                    <p className='text-navy text-subheader-bold my-4 font-bd-en'>{data.Testing}</p>
                ...
                <div className='lg:w-[363px] lg:h-[388px] flex flex-col bg-white rounded-2xl p-8 lg:py-12 sm:w-full sm:h-auto'>
                    ...
                    <p className='text-navy text-subheader-bold my-4 font-bd-en'>{data.Operations}</p>
                ...
                <div className='lg:w-[363px] lg:h-[388px] flex flex-col bg-white rounded-2xl p-8 lg:py-12 sm:w-full sm:h-auto'>
                    ...
                    <p className='text-navy text-subheader-bold my-4 font-bd-en'>{data.Community}</p>
                    <p className='text-navy07 text-body font-bd-en'>{data.CommunityIntro}</p>
                </div>
                <div className='lg:w-[363px] lg:h-[388px] flex flex-col bg-white rounded-2xl p-8 lg:py-12 sm:w-full sm:h-auto'>
                    <Image alt={'technical'} src='./svg/consulting.svg' className='bg-brand p-3 rounded-md' width={56} height={56} />
                    <p className='text-navy text-subheader-bold my-4 font-bd-en'>{data.Technical}</p>
